...
enum PostRouter: URLRequestConvertible {
    ...
    var parameters: [String: Any] {
        switch self {
        case .basicInfo(let contentId),
             .likers(let contentId),
             .commentators(let contentId),
             .mentions(let contentId):
            return ["id": contentId]
        }
    }
